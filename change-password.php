...
$chngpwd1->execute();
$msg="Slaptažodis sėkmingai pakeistas";
}
else {
$error="Neteisingas dabartinis slaptažodis. Bandykite dar kartą";  
}
}
...
<div class="col-md-12">
<h4 class="header-line">Slaptažodžio keitimas</h4>
</div>
</div>
...
<input class="form-control"  type="password" name="confirmpassword" autocomplete="off" required  />
 ...
 <button type="submit" name="change" class="btn btn-info">Pakeisti </button> 
</form>
 </div>
</div>
</div>
